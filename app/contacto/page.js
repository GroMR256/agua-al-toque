          ...
          <div className="grid-2" style={{ gap: '48px' }}>
            <div>
              ...
              {submitted && (
                <div style={{ padding: '16px 20px', borderRadius: '8px', backgroundColor: 'rgba(5, 150, 105, 0.1)', border: '1px solid var(--accent-emerald)', color: 'var(--accent-emerald)', marginBottom: '24px', fontWeight: 600 }}>
                  ✓ ¡Gracias por comunicarte! Redirigiendo a atención directa por WhatsApp...
                </div>
              )}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <li style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      ...
                      <div style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>[NÚMERO DE TELÉFONO]</div>
                    </div>
                  </li>
                  ...
                  <li style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      ...
                      <div style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>[ZONA DE COBERTURA / CIUDAD]</div>
                    </div>
                  </li>
              ...
              <div style={{ backgroundColor: 'var(--primary-navy)', color: '#FFFFFF', padding: '32px', borderRadius: '12px' }}>
                ...
                <a
                  href="https://wa.me/51999999999?text=EMERGENCIA:%20Necesito%20cisterna%20de%20agua%20urgente"
                  target="_blank"
                  rel="noreferrer"
